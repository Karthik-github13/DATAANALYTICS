...
st.title("Hello Karthik Streamlit!")
...
col1.plotly_chart(fig_bar, use_container_width=True, key="bar_chart1")
...
col2.plotly_chart(fig_bar2, use_container_width=True, key="bar_chart2")
...
col1.plotly_chart(fig_branch, use_container_width=True)  # <-- corrected
...
col2.plotly_chart(fig_employer, use_container_width=True)  # <-- corrected
